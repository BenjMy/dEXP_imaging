...
# filenames = ['MSoilR1000AnoR1Z-3.75W15H2.5L5S0Noise5',
#               'MSoilR1000AnoR1Z-13.75W15H2.5L5S0Noise5',
#               'MSoilR1000AnoR1Z-23.75W15H2.5L5S0Noise5']

filenames = ['MSoilR1000AnoR1Z-3.75W5H2.5L5S0Noise5',
              'MSoilR1000AnoR1Z-13.75W5H2.5L5S0Noise5',
              'MSoilR1000AnoR1Z-23.75W5H2.5L5S0Noise5']
# import pickle
...
ax = axs[0,0]
plt, cmap = pEXP.plot_xy(MESHratio[i],scaled=scl, label=LABELratio[i],
              markerMax=True,qratio=None,aspect_equal=True,
              ax=ax, Xaxis=x_axis,p1p2=np.array([p1,p2])) 
# plt.colorbar(cmap)
x1, x2, z1, z2 = XXZZ[i]
rectangle = plt.Rectangle((x1,abs(z1)), abs(x1-x2), abs(z1-z2),alpha=1, facecolor='none',ec="k")
ax.add_patch(rectangle)
# plt.annotate(CTm[i],[(x1 + x2)/2, -(z1+z2)/2])
# plt.tight_layout()
ax.set_aspect(aspect=5)
ax.set_title(r'$depth$:3.75m')
ax.set_xlabel('')
...
plt.savefig('dexpratio_depth.png', dpi=450)
>>>>>>> Stashed changes

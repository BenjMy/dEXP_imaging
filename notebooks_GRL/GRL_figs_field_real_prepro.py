...
plt.savefig('fig2d.eps', dpi=450)
plt.savefig('fig2d.pdf', dpi=450)
plt.savefig('fig2d.svg', dpi=450)
plt.savefig('fig2d.png', dpi=450)
...
plt.savefig('fig2e.eps', dpi=450)
plt.savefig('fig2e.pdf', dpi=450)
plt.savefig('fig2e.svg', dpi=450)
plt.savefig('fig2e.png', dpi=450)
...
plt.savefig('fig2f.eps', dpi=450)
plt.savefig('fig2f.pdf', dpi=450)
plt.savefig('fig2f.svg', dpi=450)
plt.savefig('fig2f.png', dpi=450)
